...
// undefined if loading, null if not authenticated`}
          ...
          <ApiEndpoint
            ...
            description="Start the Google OAuth sign-in flow"
            params={[
              {
                name: "provider",
                type: "\"google\"",
                description: "The only enabled provider in this template",
              },
              {
                name: "callbackURL",
                type: "string?",
                description: "Redirect URL after Google auth completes",
              },
            ]}
