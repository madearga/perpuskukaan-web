      ...
      <div className="border rounded-lg p-6 space-y-8">
        ...
        <DocSection title="Tech Stack">
          <ul className="list-disc list-inside space-y-1">
            ...
            <li>Better Auth - Google OAuth authentication</li>
...
│   ├── sign-in/     # Google login page
│   └── sign-up/     # Legacy route redirected to sign-in
...
await authClient.signOut();`}</CodeBlock>
        ...
        <DocSection title="Authentication Architecture">
          ...
          <ul className="list-disc list-inside space-y-2 ml-4">
            <li>
              ...
              ): Configures the Google OAuth provider and session handling
            </li>
            <li>
          ...
          <p className="mt-4">
            Authentication supports Google OAuth sign-in only.
          </p>
        </DocSection>
        ...
        <DocSection title="Adding OAuth Providers">
          <p>
            This template currently ships as Google-only. To add or remove
            providers:
          </p>
